...
#     def print_num(self):
#         print(self.num2)
#         ser.write(bytes(f"{self.num2}", "UTF-8"))

#     def changeValue(self, value):
#         # print(value)
#         self.label.setText(str(value // 10))
#         self.num2 = 10 + self.num * 10 + value // 10
#         # self.print_num()


# class caliButton(QPushButton):
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        # for num in range(5):
        #     label[num] = QLabel(self)
        #     label[num].setText("0")
        #     label[num].setGeometry(160 + num * 200, 40, 80, 30)
        #     slider[num] = NishikawaSlider(Qt.Horizontal, self)
        #     slider[num].set_label(label[num])
        #     slider[num].setFocusPolicy(Qt.NoFocus)
        #     slider[num].save_num(num)
        #     slider[num].setGeometry(30 + num * 200, 40, 100, 30)
        #     slider[num].valueChanged.connect(slider[num].changeValue)
        #     btn2[num] = caliButton("", self)
        #     btn2[num].set_slider(slider[num])
        #     btn2[num].setText(str(num))
        #     btn2[num].resize(200, 200)
        #     btn2[num].setFont(QFont("ＭＳ 明朝", 14, 50))
        #     s = "background-color: red;"
        #     btn2[num].save_num(num + 60)
        #     btn2[num].setStyleSheet(s)
        #     btn2[num].clicked.connect(btn2[num].print_num)
        #     layout.addWidget(btn2[num], 0, num)
        ...
        #     # slider[num].valueChanged.connect(slider[num].changeValue)
        #     # print(self.value)
        #     # label[num].setText(str(self.value))
        #     pass
